...
//
// URL: /requests — sidebar nav item, shortcut `g r` (`g l` still works).
// Renamed from "Loose ends", which said nothing about what was inside.
//
    ...
    >
      <header className="mb-8 max-w-3xl">
        ...
        <p className="text-sm text-ink-500 italic serif-italic">
          {ends.totalCount === 0
            ? "Nothing waiting. The work is clean."
            : `${ends.totalCount} ${ends.totalCount === 1 ? "thing" : "things"} waiting for you — people first, then your own loose threads.`}
        </p>
      </header>
