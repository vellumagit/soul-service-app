...
const ICON: Record<string, string> = {
  ...
  // A wrapped gift — a free resource offered to grow her list.
  leadMagnets:
    "M12 8v13m0-13c-1.5 0-3-1-3-2.5S10.5 3 12 3s3 1 3 2.5S13.5 8 12 8zM5 8h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V9a1 1 0 011-1zm1 4h12v8a1 1 0 01-1 1H7a1 1 0 01-1-1v-8z",
  calendar:
